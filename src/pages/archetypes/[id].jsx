...
export default function ArchetypeDetail() {
  ...
  const archetypes = {
    ...
    priest: {
      ...
      strengths: [
        "Equity-minded individuals are highly empathetic, valuing fairness and social responsibility.",
        "Authoritarian-minded individuals are decisive and effective at implementing large-scale solutions and maintaining order.",
        "Conservative-minded individuals value stability and tradition, preserving wisdom accumulated through generations.",
        "Religious-minded individuals often have strong moral frameworks and a sense of purpose that guides their actions.",
        "Nationalist-minded individuals foster strong community bonds and are devoted to protecting their country's interests.",
      ],
      weaknesses: [
        "Equity-minded individuals may sometimes overestimate the effectiveness of government intervention and underestimate unintended consequences.",
        "Authoritarian-minded individuals may restrict individual freedoms unnecessarily and struggle with accommodating diverse perspectives.",
        "Conservative-minded individuals may resist beneficial change and adaptations necessary in a rapidly evolving world.",
        "Religious-minded individuals may sometimes impose their beliefs on others who don't share the same worldview.",
        "Nationalist-minded individuals may overlook global cooperation opportunities and treat outsiders with undue suspicion.",
      ],
      famousPeople: [
