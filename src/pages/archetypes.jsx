...
export default function ArchetypePage() {
  ...
  const allArchetypes = [
    ...
    {   
      ...
      id: "firebrand",
      name: "The Firebrand",
      traits: ["Equity", "Libertariany", "Progressive", "Religious", "Nationalist"],
      slug: "firebrand",
    },
    {
      id: "philosopher",
    ...
    },
    {
      id: "maverick",
      name: "The Maverick",
      traits: ["Markets", "Libertarian", "Progressive", "Secular", "Nationalist"],
      slug: "maverick",
    },
    {
      id: "evangelist",
      name: "The Evangelist",
      traits: ["Markets", "Libertarian", "Progressive", "Religious", "Globalist"],
      slug: "evangelist",
    },
    {
      id: "dissenter",
      name: "The Dissenter",
      traits: ["Markets", "Libertarian", "Progressive", "Religious", "Nationalist"],
      slug: "dissenter",
    },
    {
      id: "globalist",
      name: "The Globalist",
      traits: ["Markets", "Libertarian", "Conservative", "Secular", "Globalist"],
      slug: "globalist",
    },
    {
      id: "patriot",
      name: "The Patriot",
      traits: ["Markets", "Libertarian", "Conservative", "Secular", "Nationalist"],
      slug: "patriot",
    },
    {
      id: "industrialist",
      name: "The Industrialist",
      traits: ["Markets", "Libertarian", "Conservative", "Religious", "Globalist"],
      slug: "industrialist",
    },
    {
      id: "traditionalist",
      name: "The Traditionalist",
      traits: ["Markets", "Libertarian", "Conservative", "Religious", "Nationalist"],
      slug: "traditionalist",
    },
    {
      id: "overlord",
    ...
    },
    {
      id: "builder",
      name: "The Builder",
      traits: ["Markets", "Authority", "Progressive", "Religious", "Nationalist"],
      slug: "builder",
    },
    {
      id: "executive",
    ...
    },
    {
      id: "ironhand",
      name: "The Ironhand",
      traits: ["Markets", "Authority", "Conservative", "Secular", "Nationalist"],
      slug: "ironhand",
    },
    {
      id: "traditionalist",
      name: "The Traditionalist",
      traits: ["Markets", "Authority", "Conservative", "Religious", "Globalist"],
      slug: "traditionalist",
    },
    {
      id: "crusader",
      name: "The Crusader",
      traits: ["Markets", "Authority", "Conservative", "Religious", "Nationalist"],
      slug: "crusader",
    },
  ];
